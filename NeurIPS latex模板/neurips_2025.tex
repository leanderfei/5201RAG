...
\author{
Student A (ID: \underline{\hspace{3cm}}) \and
Student B (ID: \underline{\hspace{3cm}}) \and
Student C (ID: \underline{\hspace{3cm}})
}
\date{Spring 2026}
...
\begin{enumerate}[leftmargin=1.4em]
  ...
  \item Chroma Documentation.
  \item BAAI BGE Embedding Model Card.
  \item Tongyi Qwen API Documentation.
\end{enumerate}
...
\vspace{0.8em}
\textbf{Instructions:}
For each member, provide (1) Full Name + Student ID, (2) Responsible report sections,
and (3) concrete task description.
...
\hline
Member 1: \newline \underline{\hspace{6cm}} &
Sections: \newline \underline{\hspace{8cm}} &
Tasks: data collection, preprocessing, and report drafting details: \newline \underline{\hspace{8cm}} \\
\hline
Member 2: \newline \underline{\hspace{6cm}} &
Sections: \newline \underline{\hspace{8cm}} &
Tasks: indexing/retrieval pipeline implementation and testing details: \newline \underline{\hspace{8cm}} \\
\hline
Member 3: \newline \underline{\hspace{6cm}} &
Sections: \newline \underline{\hspace{8cm}} &
Tasks: LLM integration, demo preparation, and result analysis details: \newline \underline{\hspace{8cm}} \\
\hline
Member 4 (if any): \newline \underline{\hspace{6cm}} &
Sections: \newline \underline{\hspace{8cm}} &
Tasks: presentation coordination, Q\&A preparation, and revision details: \newline \underline{\hspace{8cm}} \\
\hline
\end{longtable}
